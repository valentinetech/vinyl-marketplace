export enum AboutEnum {
	par = `Vinyl Auction are the No.1 auction house worldwide for rare & collectable vinyl records, selling around 500,000 records every year in our specialist vinyl record auctions.  We cover ALL genres, the only criteria is that the records are considered collectable. \n
